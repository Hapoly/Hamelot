...
class HospitalUsers extends Controller{
  public function index(Request $request){
    ...
    return view('manager.hospital_users.index', [
  ...
  public function show(HospitalUser $hospital_user){
    return view('manager.hospital_users.show', ['hospital_user' => $hospital_user]);
  }
  public function create(){
    return view('manager.hospital_users.create', [
  ...
  public function edit(HospitalUser $hospital_user){
    return view('manager.hospital_users.edit', [
