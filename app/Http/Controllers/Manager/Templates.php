...
class Templates extends Controller{
  public function index(Request $request){
    ...
    return view('manager.templates.index', [
      'templates'   => $templates,
      'links'       => $links,
      'sort'        => $sort,
      'search'      => $search,
  ...
  public function show(Template $template){
    return view('manager.templates.show', ['template' => $template]);
  }
  public function create(){
    return view('manager.templates.create');
  }
  ...
  public function edit(Template $template){
    return view('manager.templates.edit', ['template' => $template]);
  }
