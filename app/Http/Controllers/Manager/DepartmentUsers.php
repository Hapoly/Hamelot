...
class DepartmentUsers extends Controller{
  public function index(Request $request){
    ...
    return view('manager.department_users.index', [
  ...
  public function show(DepartmentUser $department_user){
    return view('manager.department_users.show', ['department_user' => $department_user]);
  }
  public function create(){
    return view('manager.department_users.create', [
  ...
  public function edit(DepartmentUser $department_user){
    return view('manager.department_users.edit', [
