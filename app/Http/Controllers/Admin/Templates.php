...
class Templates extends Controller{
  ...
  public function show(Template $template){
    return view('panel.templates.show', ['template' => $template]);
  }
  ...
  public function store(TemplateRequest $request){
    ...
    return redirect()->route('panel.templates.show', ['template' => $template]);
  }
  public function edit(Template $template){
    return view('panel.templates.edit', ['template' => $template]);
  }
  ...
  public function destroy(Template $template){
    $template->delete();
    if(URL::route('panel.templates.show', ['template' => $template]) == URL::previous())
