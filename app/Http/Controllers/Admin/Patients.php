...
class Patients extends Controller{
  ...
  public function show(Patient $patient){
    return view('panel.patients.show', ['patient' => $patient]);
  }
  ...
  public function store(PatientRequest $request){
    ...
    return redirect()->route('panel.patients.show', ['patient' => $patient]);
  }
  ...
  public function destroy(Patient $patient){
    $patient->delete();
    if(URL::route('panel.patients.show', ['patient' => $patient]) == URL::previous())
