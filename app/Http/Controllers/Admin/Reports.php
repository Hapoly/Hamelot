...
class Reports extends Controller{
  ...
  public function show(Report $report){
    return view('panel.reports.show', ['report' => $report]);
  }
  ...
  public function store(ReportRequest $request){
    ...
    return redirect()->route('panel.reports.show', ['report' => $report]);
  }
  public function edit(Report $report){
    return view('panel.reports.edit', [
      'report'    => $report,
      'keys'      => Key::where('status', Key::S_ACTIVE)->get(),
      'hospitals' => Hospital::where('status', Hospital::S_ACTIVE)->get(),
      'patients'  => Patient::where('status', Patient::S_ACTIVE)->get(),
  ...
  public function destroy(Report $report){
    $report->delete();
    if(URL::route('panel.reports.show', ['report' => $report]) == URL::previous())
