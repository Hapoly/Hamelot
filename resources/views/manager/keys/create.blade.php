...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('keys.create') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('manager.keys.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="type" id="type">
                                    <option value="1">{{__('keys.type_str.1')}}  </option>
                                    <option value="2">{{__('keys.type_str.2')}}  </option>
                                    <option value="3">{{__('keys.type_str.3')}}  </option>
                                </select>
                                @if ($errors->has('type'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="status" id="status">
                                    <option value="1">{{__('keys.status_str.1')}}  </option>
                                    <option value="2">{{__('keys.status_str.2')}}  </option>
                                </select>
