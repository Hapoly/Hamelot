...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
              <div class="card-header">{{ __('hospitals.edit')}}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('manager.hospitals.update', ['hospital' => $hospital]) }}" enctype="multipart/form-data">
                        {{ method_field('PUT') }}
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" value="{{ old('address', $hospital->address) }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="phone" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone', $hospital->phone) }}" required>
                                @if ($errors->has('phone'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="phone" class="form-control{{ $errors->has('mobile') ? ' is-invalid' : '' }}" name="mobile" value="{{ old('mobile', $hospital->mobile) }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="status" id="status">
                                    <option value="1" {{old('status', $hospital->status) == 1? 'selected': ''}} >{{__('users.status_str.1')}}  </option>
                                    <option value="2" {{old('status', $hospital->status) == 2? 'selected': ''}} >{{__('users.status_str.2')}}  </option>
                                </select>
