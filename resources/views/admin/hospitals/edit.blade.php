                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('hospitals.update', ['hospital' => $hospital]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone', $hospital->phone) }}" required>
                                @if ($errors->has('phone'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="text" class="form-control{{ $errors->has('mobile') ? ' is-invalid' : '' }}" name="mobile" value="{{ old('mobile', $hospital->mobile) }}" required>
