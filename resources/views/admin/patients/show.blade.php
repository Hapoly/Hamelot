    ...
    <div class="col-md-8">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            <a href="{{route('admin.patients.edit', ['patient' => $patient])}}" class="btn btn-primary" role="button">{{__('patients.edit')}}</a>
            <form action="{{route('admin.patients.destroy', ['patient' => $patient])}}" method="post">
              {{ method_field('DELETE') }}
              {{ csrf_field() }}
