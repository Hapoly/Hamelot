...
<div class="container">
  @form_create(['action' => route('panel.activity-times.store'), 'title' => __('activity_times.create')])
    ...
    <div class="row">
      ...
      @endphp
      @input_select(['help' => __('activity_times.auto_fill_description'), 'name' => 'auto_fill', 'value' => old('auto_fill', '1'), 'col'=>6, 'label' => __('activity_times.auto_fill'), 'required' => true, 'rows' => $auto_fill_rows])
      @php
    ...
    <div class="row">
      @input_currency(['help' => __('activity_times.deafult_price_description'), 'name' => 'default_price', 'value' => old('default_price', 1000), 'label' => __('activity_times.default_price'), 'col'=>6, 'required' => true, 'min' => 0, 'max' => 9999999, 'step' => 1, 'placeholder' => __('general.tmn')])
      @input_currency(['help' => __('activity_times.default_deposit_description'), 'name' => 'default_deposit', 'value' => old('default_deposit', 0), 'label' => __('activity_times.default_deposit'), 'col'=>6, 'required' => true, 'min' => 1000, 'max' => 9999999, 'step' => 1, 'placeholder' => __('general.tmn')])
    </div>
    <div class="row">
      @input_number(['help' => __('activity_times.deamnd_limit_description'), 'name' => 'demand_limit', 'value' => old('demand_limit', 0), 'label' => __('activity_times.demand_limit'), 'col'=>6, 'required' => true, 'min' => 0, 'max' => 1000, 'placeholder' => 'نفر'])
      @input_number(['help' => __('activity_times.default_demand_time_description'), 'name' => 'default_demand_time', 'value' => old('default_demand_time', 0), 'label' => __('activity_times.default_demand_time'), 'col'=>6, 'required' => true, 'min' => 0, 'max' => 1000, 'placeholder' => 'نفر'])
    </div>
