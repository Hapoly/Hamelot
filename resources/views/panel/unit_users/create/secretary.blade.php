...
@section('title', __('unit_users.create.secretary'))
@section('content')
<?php
...
<div class="container">
  ...
  @endif
  @form_create(['action' => route('panel.unit_users.store'), 'title' => __('unit_users.create.secretary')])
    @autocomplete(['name' => 'full_name', 'label' => __('unit_users.full_name'), 'value' => old('full_name', $full_name), 'required' => true, 'route' => 'secretaries', 'row' => true])
    @php
      $unit_strs = [];
