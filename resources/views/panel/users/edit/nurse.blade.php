...
@form_edit(['post' => true, 'action' => route('panel.users.update.nurse', ['user' => $user]), 'title' => __('users.edit.nurse')])
        ...
        <div class="form-group row create-form">
            ...
            @endphp
            @input_select(['name' => 'public', 'value' => old('public', $user->nurse->public), 'label' => __('users.public'), 'required' => true, 'rows' => $public_rows, 'col' => 6])
            ...
            @endphp
            @input_select(['name' => 'status', 'value' => old('status', $user->nurse->status), 'label' => __('users.status'), 'required' => true, 'rows' => $status_rows, 'col' => 6])
        </div>
