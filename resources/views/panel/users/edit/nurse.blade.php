...
@form_edit(['post' => true, 'action' => route('panel.users.update.nurse', ['user' => $user]), 'title' => __('users.edit.nurse')])
        ...
        @input_text(['name' => 'slug', 'label' => __('users.slug'), 'value' => old('slug', $user->slug), 'row' => true])
        @php
            $gender_rows = [
        ...
        @endphp
        @input_select(['name' => 'gender', 'value' => old('gender', $user->nurse->gender), 'label' => __('users.gender'), 'required' => true, 'rows' => $gender_rows, 'row' => true])
        
        @input_text(['name' => 'msc', 'label' => __('users.msc'), 'value' => old('msc', $user->msc), 'row' => true])
        @php
            $public_rows = [
        ...
        @endphp
        @input_select(['name' => 'public', 'value' => old('public', $user->nurse->public), 'label' => __('users.public'), 'required' => true, 'rows' => $public_rows, 'row' => true])
        @if(Auth::user()->isAdmin())
            @php
                $status_rows = [
            ...
            @endphp
            @input_select(['name' => 'status', 'value' => old('status', $user->nurse->status), 'label' => __('users.status'), 'required' => true, 'rows' => $status_rows, 'row' => true])
        @endif
